...
- Having issue with playing videos using videoview
- Had issue with offline load
- I encountered a lot of troubles with data binding with recycle view and start activity.
